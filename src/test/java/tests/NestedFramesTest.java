...
public class NestedFramesTest extends BaseTest {
    ...
    public void shouldReadTextsFromNestedFrames() {
        ...
        Assert.assertEquals(nestedFramesPage.getFrameText(), "MIDDLE", "Unexpected text in middle frame.");

        nestedFramesPage.switchToDefaultContent();
        nestedFramesPage.switchToTopFrame();
        nestedFramesPage.switchToRightFrame();
        Assert.assertEquals(nestedFramesPage.getFrameText(), "RIGHT", "Unexpected text in right frame.");

        nestedFramesPage.switchToDefaultContent();
        nestedFramesPage.switchToBottomFrame();
        Assert.assertEquals(nestedFramesPage.getFrameText(), "BOTTOM", "Unexpected text in bottom frame.");
    }
}
